...
import com.RESTFULL.WEBSERVICES.users.UserNotFoundException;
...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(
		...
		Execptionresponse execptionresponse = new Execptionresponse(new Date(), "Validation failed", ex.getBindingResult().toString());
